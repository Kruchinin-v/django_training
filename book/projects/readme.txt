...
Подсистема отправки электронных писем настроена на использование отладочного SMTP-сервера
Python, работающего через TCP-порт №1025. Для запуска отладочного SMTP-сервера следует
открыть другой экземпляр командной строки и отдать в ней команду:
...
? Apache HTTP Server — 2.4.41 VC 15, 64-разрядная редакция; 
